    ...
    def __call__(self,
        ...
        for img, prompt in zip(images, prompts):
            ...
            try:
                ...
                recognized_text = ''.join([res[1][0] if res[1][1] > 0 else '' for res in result[0]]) if result[
                    0] else ''
...
class OcrScorer_video_or_image:
    ...
    @torch.no_grad()
    def __call__(self, images: Union[List[Image.Image], List[np.ndarray]], prompts: List[str]) -> Tuple[
